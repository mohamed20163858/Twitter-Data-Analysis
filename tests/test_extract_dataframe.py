...
sampletweetsjsonfile = "me.json"   #put here the path to where you placed the file e.g. ./sampletweets.json. 
...
class TestTweetDfExtractor(unittest.TestCase):
    ...
    def test_find_sentiments(self):
        self.assertEqual(
            ...
            (
                [-1.250000e-01,-1.000000e-01,0.000000e+00,1.000000e-01,-6.938893903907228e-18],
                [0.190625,0.100000,0.000000,0.350000,0.556250],
            ),
        )
